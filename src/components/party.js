...
export function heartEmitter(source) {
...
party.resolvableShapes["confettiEmoji"] = `<span>🎉</span>`;

export function confettiEmitter(source) {
    party.confetti(source, {
        count: party.variation.range(5, 20),
        shapes: ["square", "circle", "star", "confettiEmoji"],
    });
}
